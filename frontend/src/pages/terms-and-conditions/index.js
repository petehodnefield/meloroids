...
const TermsAndConditions = () => {
  return (
    <div>
      ...
      <div>
        <h2>Agreement between User and https://www.meloroids.io</h2>
        <p>
          ...
          Meloroids LLC. https://www.meloroids.io is offered to you conditioned
          on your acceptance without modification of the terms, conditions, and
          notices contained herein (the "Terms"). Your use of
          https://www.meloroids.io constitutes your agreement to all such Terms.
          Please read these terms carefully, and keep a copy of them for your
          reference.
        </p>
        <p>https://www.meloroids.io is a News and Information Site.</p>
        <p>
          Meloroids is a resource for music producers to write better melodies.
          We currently offer 3 products: Quickie, Target, and Artist Target.
          Quickie is a file name generator. Target gives inspiration by
          providing chord progressions for popular genres. Artist Target pulls
          data from an artist&#39;s discography and gives them to the producer.
        </p>
      </div>
      ...
      <div>
        <h2>Privacy</h2>
        <p>
          Your use of https://www.meloroids.io is subject to Meloroids LLC&#39;s
      ...
      <div>
        ...
        <p>
          ...
          entity. You acknowledge that Meloroids LLC is not responsible for
          third party access to your account that results from theft or
          misappropriation of your account. Meloroids LLC and its associates
      ...
      <div>
        ...
        <p>
          https://www.meloroids.io may contain links to other websites ("Linked
          Sites"). The Linked Sites are not under the control of Meloroids LLC
          and Meloroids LLC is not responsible for the contents of any Linked
          Site, including without limitation any link contained in a Linked
          Site, or any changes or updates to a Linked Site. Meloroids LLC is
          providing these links to you only as a convenience, and the inclusion
          of any link does not imply endorsement by Meloroids LLC of the site or
        ...
        <p>
          ...
          that Meloroids LLC may share such information and data with any third
          party with whom Meloroids LLC has a contractual relationship to
          provide the requested product, service or functionality on behalf of
          https://www.meloroids.io users and customers.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          to access and use https://www.meloroids.io strictly in accordance with
        ...
        <p>
          ...
          used on the Site, is the property of Meloroids LLC or its suppliers
      ...
      <div>
        ...
        <p>
          The Service is controlled, operated and administered by Meloroids LLC
          ...
          local laws. You agree that you will not use the Meloroids LLC Content
          accessed through https://www.meloroids.io in any country or in any
      ...
      <div>
        ...
        <p>
          You agree to indemnify, defend and hold harmless Meloroids LLC, its
          ...
          rules or regulations. Meloroids LLC reserves the right, at its own
          ...
          fully cooperate with Meloroids LLC in asserting any available
          defenses.
        </p>
      </div>
      ...
      <div>
        ...
        <p>
          ...
          OTHER. Further, unless both you and Meloroids LLC agree otherwise, the
      ...
      <div>
        ...
        <p>
          ...
          MELOROIDS LLC AND/OR ITS SUPPLIERS MAY MAKE IMPROVEMENTS AND/OR
          CHANGES IN THE SITE AT ANY TIME.
        </p>
        <p>
          MELOROIDS LLC AND/OR ITS SUPPLIERS MAKE NO REPRESENTATIONS ABOUT THE
          ...
          CONDITION OF ANY KIND. MELOROIDS LLC AND/OR ITS SUPPLIERS HEREBY
        ...
        <p>
          ...
          MELOROIDS LLC AND/OR ITS SUPPLIERS BE LIABLE FOR ANY DIRECT, INDIRECT,
          ...
          STRICT LIABILITY OR OTHERWISE, EVEN IF MELOROIDS LLC OR ANY OF ITS
      ...
      <div>
        <h2>Terminatino/Access Restriction</h2>
        <p>
          Meloroids LLC reserves the right, in its sole discretion, to terminate
          ...
          Minnesota and you hereby consent to the exclusive jurisdiction and
          venue of courts in Minnesota in all disputes arising out of or
        ...
        <p>
          ...
          relationship exists between you and Meloroids LLC as a result of this
          agreement or use of the Site. Meloroids LLC&#39;s performance of this
          agreement is subject to existing laws and legal process, and nothing
          contained in this agreement is in derogation of Meloroids LLC&#39;s
          ...
          provided to or gathered by Meloroids LLC with respect to such use. If
        ...
        <p>
          ...
          entire agreement between the user and Meloroids LLC with respect to
          ...
          and Meloroids LLC with respect to the Site. A printed version of this
      ...
      <div>
        ...
        <p>
          ...
          Meloroids LLC encourages you to periodically review the Terms to stay
      ...
      <div>
        <h2>Contact Us</h2>
        <p>
          Meloroids LLC welcomes your questions or comments regarding the Terms:
        </p>
        <div>
          <p>Meloroids LLC</p>
