        ...
        <div
            ...
            <div className='md:justify-center w-full max-w-58  flex lg:justify-end'>
                <div
                    ...
                    <LoginForm />
                    <p className='text-0.875 font-semibold text-center md:text-left'>Don&apos;t have an account? <Link href='/signup' className='text-primary hover:opacity-80'>Create one </Link></p>
                </div>
            </div>
