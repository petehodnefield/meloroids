    ...
    return (
        <section className='flex flex-col items-center pt-10 pb-10'>
            ...
            <Image
                ...
                className='object-cover px-6 h-48 border-2 border-primary'
            />
            <div className='px-6 pt-6 pb-8'>
                <p className='text-1 mb-6'>With Artist Target, you can experiment with different melodies and harmonies while also learning how to emulate the sound of your favorite artists. Whether you're an experienced musician or just starting out, our feature is a fun and effective way to improve your songwriting skills.</p>
